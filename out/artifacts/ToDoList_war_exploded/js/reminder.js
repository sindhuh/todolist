var reminderFunction = function (id) {
    ...
    $(id).click(function () {
        ...
        $("#timeSetButton-" + idAfterSplit).click(function () {
            ...
            setTimeout(function () {
                timerFunction(userEnteredDate, idAfterSplit , hours)
            }, 1000);
        })
    })
}
var timerFunction = function (inputDate , id , hours) {
    ...
    console.log("hrs diff :" +diffhours);
    var diffminutes = Math.floor((differenceTravel) / (1000 * 60));
    console.log("min diff :" +diffminutes);
    ...
    setTimeout(function () {
        timerFunction(inputDate, id ,hours)
    }, 1000);
}